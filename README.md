...
отвечать на ваши вопросы (задавайте их в чате или менеджеру программы обучения),
...
типизацией. Расскажем, почему мы выбрали именно этот язык.
...
коммерческий софт, и который при этом позволяет четко отделять
[чистые части программы](https://ru.wikipedia.org/wiki/%D0%A7%D0%B8%D1%81%D1%82%D0%BE%D1%82%D0%B0_%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D0%B8)
от [частей с сайд-эффектами](https://en.wikipedia.org/wiki/Side_effect_(computer_science)). У
...
т.д. Также в плюсы можно добавить колоссальную выразительность языка и его
...
планируется долгое развитие проекта, с Haskell же мы имеем кодовую базу, которая
...
- Github написали Semantic на Haskell,
  [читать подробности о выборе языка](https://github.com/github/semantic/blob/7364e164947116406850ff6f298d80ba77105229/docs/why-haskell.md).
- [Haskell в большом трейдинговом проекте](https://skillsmatter.com/skillscasts/9098-haskell-in-the-large-the-day-to-day-practice-of-using-haskell-to-write-large-systems).
...
- Параллельно выполнять каты из [Codewars](https://www.codewars.com/kata/search/haskell).
  ...
  1. [Disemvowel trolls](https://www.codewars.com/kata/disemvowel-trolls):
  ...
  1. [Highest and lowest](https://www.codewars.com/kata/highest-and-lowest):
  ...
  1. [Isograms](https://www.codewars.com/kata/isograms/):
  ...
  1. [Split strings](https://www.codewars.com/kata/split-strings):
  ...
  1. [Tribonacci sequence](https://www.codewars.com/kata/tribonacci-sequence):
  ...
  1. [Title case](https://www.codewars.com/kata/title-case):
...
- Обязательно попробуйте найти и пройти от 3-х кат самостоятельно! Также
  ...
  1. [Valid braces](https://www.codewars.com/kata/5277c8a221e209d3f6000b56):
  ...
  1. [Product of consecutive Fib numbers](https://www.codewars.com/kata/5541f58a944b85ce6d00006a):
  ...
  1. [Reverse words](https://www.codewars.com/kata/reverse-words):
  ...
  1. [Snail](https://www.codewars.com/kata/snail/haskell):
  ...
  1. [Equal sides of array](https://www.codewars.com/kata/equal-sides-of-an-array/train/haskell):
  ...
  1. [Go so far around to the right that you end up left](https://www.codewars.com/kata/5424e78460d77749f2000279):
  ...
  1. [Take a Ten Minute Walk](https://www.codewars.com/kata/54da539698b8a2ad76000228):
  ...
  1. [Highest Rank Number in an Array](https://www.codewars.com/kata/5420fc9bb5b2c7fd57000004/haskell):
  ...
  1.  [Next bigger number with the same digits](https://www.codewars.com/kata/55983863da40caa2c900004e):
  ...
  1.  [Find The Parity Outlier](https://www.codewars.com/kata/5526fc09a1bbd946250002dc/haskell):
  ...
  1.  [Most frequently used words in a text](https://www.codewars.com/kata/51e056fe544cf36c410000fb/haskell):
      достаточно простая ката для 4 кью. Тренирует обработку строки с
      использованием `Data.Char` и `Data.List`.

  1.  [Fibonacci, Tribonacci and friends](https://www.codewars.com/kata/556e0fccc392c527f20000c5/haskell):
      логическое продолжение каты Tribonacci, достаточно интересное и
      неординарное решение, тренирует мозги.

  1.  [Sortable Shapes](https://www.codewars.com/kata/586669a8442e3fc307000048):
  ...
  1. [Recurrence relations](https://www.codewars.com/kata/recurrence-relations/haskell)

  1. [Simple Fun #74: Growing Plant](https://www.codewars.com/kata/58941fec8afa3618c9000184)

  1. [Coloured Triangles](https://www.codewars.com/kata/coloured-triangles)

  1. [Digital Root](https://www.codewars.com/kata/541c8630095125aba6000c00)

  1. [Twice linear](https://www.codewars.com/kata/5672682212c8ecf83e000050/train/haskell)

  1. [Playing with laziness](https://www.codewars.com/kata/5516b80d891547c9b50007fd/haskell)

  1. [Break camelCase](https://www.codewars.com/kata/5208f99aee097e6552000148)

  1. [CamelCase Method](https://www.codewars.com/kata/587731fda577b3d1b0001196)

  1. [Speed Control](https://www.codewars.com/kata/speed-control/haskell)
